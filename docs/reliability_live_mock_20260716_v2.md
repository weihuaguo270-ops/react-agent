# Live Harness 可靠性对照（reliability_live_mock_20260716_v2）

- **report_id:** `reliability_live_20260716_010436`
- **timestamp:** `2026-07-16T01:04:36.463080+00:00`
- **mode:** `mock`
- **git:** `98817ff`
...
| Guard+自修 **OFF** | 0 | 20 | **0.0%** | 3.0 | 1.0 | 100.0% |

- ON 独过（OFF 失败）场景数: **20/20**
...
| `live_flaky_calc_12x12` | flaky | `calculator:2` | Y | N | Y |
| `live_flaky_calc_9x9` | flaky | `calculator:2` | Y | N | Y |
| `live_flaky_calc_25x4` | flaky | `calculator:2` | Y | N | Y |
| `live_flaky_calc_33x3` | flaky | `calculator:2` | Y | N | Y |
| `live_flaky_calc_48_div_6` | flaky | `calculator:2` | Y | N | Y |
| `live_flaky_calc_7x8` | flaky | `calculator:2` | Y | N | Y |
| `live_flaky_calc_21x5` | flaky | `calculator:2` | Y | N | Y |
| `live_flaky_calc_13x14` | flaky | `calculator:2` | Y | N | Y |
| `live_flaky_calc_16x16` | flaky | `calculator:2` | Y | N | Y |
...
| `live_flaky_py_fact4` | flaky | `execute_python:1` | Y | N | Y |
| `live_flaky_py_sum10` | flaky | `execute_python:1` | Y | N | Y |
| `live_flaky_py_pow3` | flaky | `execute_python:1` | Y | N | Y |
| `live_flaky_py_len` | flaky | `execute_python:1` | Y | N | Y |
| `live_flaky_py_abs` | flaky | `execute_python:1` | Y | N | Y |
