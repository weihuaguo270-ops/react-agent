...
def run_mock_agent(query: str) -> dict:
    """Simulate agent execution and produce a 1-based Format B trajectory."""
    t = start_trajectory(query, model="mock-gpt")
    t.add_step(1, thought="User wants to know about Python sort")
    t.add_step(
        2,
        thought="Searching...",
    ...
    t.add_step(
        3,
        thought="Got enough info to answer",
...
def demo_eval_trajectory(trajectory_path: str):
    ...
    def mock_judge(prompt: str) -> dict:
        return {
            ...
            "reasoning": "Reasonable steps",
            "needs_revision": False,
            "strengths": ["clear tool use"],
            "weaknesses": [],
            "details": [],
        }
